...
var ClassicTheme = function (_React$PureComponent) {
  ...
  _createClass(ClassicTheme, [{
    ...
    value: function checkTimeIsActive(time) {
      ...
      if (meridiem && meridiem !== rawMeridiem) {        return false;
      }
    ...
    value: function render12Hours() {
      ...
      if (withMinTime) sliceLow = _const_value.TIMES_12_MODE.findIndex(function (time) {
        return time === withMinTime;
      });
      if (withMinTime) sliceHigh = _const_value.TIMES_12_MODE.findIndex(function (time) {
        return time === withMinTime;
      });
    ...
    value: function render24Hours() {
      ...
      if (withMinTime) sliceLow = _const_value.TIMES_24_MODE.findIndex(function (time) {
        return time === withMinTime;
      });
      if (withMinTime) sliceHigh = _const_value.TIMES_24_MODE.findIndex(function (time) {
