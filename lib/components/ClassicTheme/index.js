...
var ClassicTheme = function (_React$PureComponent) {
  ...
  _createClass(ClassicTheme, [{
    ...
    value: function render12Hours() {
      ...
      if (withMinTime) {
        sliceLow = _const_value.TIMES_24_MODE.findIndex(function (time) {
          return time === withMinTime;
        }) + 1;
      }
      if (withMaxTime) {
        sliceHigh = _const_value.TIMES_24_MODE.findIndex(function (time) {
          return time === withMaxTime;
        }) - 1;
      }
      return [].concat(_toConsumableArray(_const_value.TIMES_12_MODE)).slice(sliceLow, sliceHigh + 1).map(function (hourValue, index) {
    ...
    value: function render24Hours() {
      ...
      return [].concat(_toConsumableArray(_const_value.TIMES_24_MODE)).slice(sliceLow, sliceHigh + 1).map(function (hourValue, index) {
